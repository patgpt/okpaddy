...
var contentlayer_config_default = makeSource({
  ...
  documentTypes: [Service, defineDocumentType(() => ({
    name: "Post",
    ...
    computedFields: {
      slug: {
        type: "string",
        resolve: (doc) => doc._raw.sourceFilePath.replace(/^blog\//, "").replace(/\.mdx?$/, "")
      },
      url: { type: "string", resolve: (p) => `/blog/${p._raw.sourceFilePath.replace(/^blog\//, "").replace(/\.mdx?$/, "")}` }
    }
  }))],
  mdx: {
...
//# sourceMappingURL=compiled-contentlayer-config-MQZJ27DA.mjs.map
